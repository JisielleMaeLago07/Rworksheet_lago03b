...
dframe <- data.frame(
  Respondents = 1:20,
  Sex = c(2,2,1,2,2,2,2,2,
          2,2,1,2,2,2,2,2,
          2,2,1,2),
  
  Fathers_Occupation = c(1,3,3,3,1,2,3,
                         1,1,1,3,2,1,3,3,1,
                         3,1,2,1),
  
  Persons_Home = c(5,7,3,8,5,9,6,7,8
                   ,4,7,5,4,7,8,8,3
                   ,11,7,6),
  
  Siblings_school = c(6,4,4,1,2,
                      1,5,3,1,2,3,2,
                      5,5,2,1,2,5,3,2),
  
  Types_houses = c(1,2,3,1,1,
                   3,3,1,2,3,2,3,2,
                   2,3,3,3,3,3,2))
dframe
